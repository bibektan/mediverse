                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('backend.recycle') }}">Recycle Bin</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <form action="">
                <div class="p-1 bg-light rounded rounded-pill shadow ">
                  <div class="input-group">
                    <input wire:model="blogsearch" type="search" placeholder="What're you searching for?" aria-describedby="button-addon1" class="form-control border-0 bg-light">
                    ...
                    @foreach ($blog as $k=>$v)
                        <div class="col-lg-10 col-10 col-md-10 mx-auto">
                            <div class="bg-light rounded rounded-pill shadow">
                                <div class="card">
                                    <div class="card-body">
                                    <h5 class="card-title"><a href="{{route('backend.blog.preview',['id'=>$v->id, 'type'=>'blog'])}}">{{$v->title}}</a></h5>
                            ...
                            <div class=" bg-light rounded shadow">
                                <div class="row">
                                    <div class="col-md-6 fs-5 justify-content-center text-center">
                                        <a href="{{ route('backend.blog', ['id'=>$v->id]) }}"><i style="cursor: pointer" class="fa fa-edit text-success"></i></a>
                                    </div>
                                    <div class="col-md-6 fs-5 justify-content-center text-center">
                    ...
                    <div class="row mt-3 bg-light rounded shadow">
                        ...
                        <div class="col-md-6">
                            <div class="card bg-light">
                                ...
                                <h5 class="card-title"><a href="{{route('backend.blog.preview',['id'=>$v->id, 'type'=>'video'])}}">{{$v->title}}</a></h5>
                                <p class="card-text">{{ $v->short_description }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mx-auto">
                            <div class=" bg-light rounded shadow">
                                <div class="row">
                                    <div class="col-md-6 fs-5 justify-content-center text-center">
                                        <a href="{{ route('backend.upload', ['id'=>$v->id, 'type'=>'video']) }}"><i style="cursor: pointer" class="fa fa-edit text-success"></i></a>
                                    </div>
                                    <div class="col-md-6 fs-5 justify-content-center text-center">
                            ...
                            <div class="card-text">
                                ...
                                <div class="mx-auto">
                                    <div class=" bg-light rounded shadow">
                                        <div class="row">
                                            <div class="col-md-6 fs-5 justify-content-center text-center">
                                                <a href="{{ route('backend.upload', ['id'=>$v->id, 'type'=>'meme']) }}"><i style="cursor: pointer" class="fa fa-edit text-success"></i></a>
                                            </div>
                                            <div class="col-md-6 fs-5 justify-content-center text-center">
